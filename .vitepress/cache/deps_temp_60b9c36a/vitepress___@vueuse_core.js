import {
  ...
  watch,
  watchEffect,
} from "./chunk-ND7OBVOM.js";

// node_modules/.pnpm/vitepress@1.1.4_@algolia+client-search@4.23.3_@types+node@20.11.30_search-insights@2.13.0_typescript@5.4.2/node_modules/vitepress/lib/vue-demi.mjs
var isVue2 = false;
var isVue3 = true;
...
function useClipboard(options = {}) {
  ...
  function legacyRead() {
    var _a, _b, _c;
    return (_c =
      (_b = (_a = document == null ? void 0 : document.getSelection) == null ? void 0 : _a.call(document)) == null ? void 0 : _b.toString()) != null
      ? _c
      : "";
  }
...
function isFetchOptions(obj) {
  return (
    obj &&
    containsProp(obj, "immediate", "refetch", "initialData", "timeout", "beforeFetch", "afterFetch", "onFetchError", "fetch", "updateDataOnError")
  );
}
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = (e) => {
    ...
    return (_c =
      (_b = (_a = options.pointerTypes) == null ? void 0 : _a.includes(e.pointerType)) != null ? _b : isReleasingButton || isPrimaryButton) != null
      ? _c
      : true;
  };
  const stops = [
